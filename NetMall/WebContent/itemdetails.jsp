...
//  CartBean   cb = (CartBean) objCartBean ;
...
<p><font size="3" face="Verdana, Arial, Helvetica, sans-serif"><strong>AVAILABLE ITEMS
</strong></font></p>
<div><a href="ShoppingCart.jsp">View Cart</a></div>
<!--  <p/> -->    
